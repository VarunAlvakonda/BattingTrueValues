...
def main():
    ...
    if st.button('Analyse'):
        ...
        if choice == 'Overall Stats':
            ...
            fig = px.scatter(final_results4.round(2), x='True Ave', y='True SR', size='Runs Scored',text='Player',size_max=30, hover_data=['Player','Runs Scored','BF','Ave','SR'])
            ...
            fig = px.scatter(combined_data.round(2), x='True Ave', y='True SR', size='Runs Scored',text='Player',size_max=30, hover_data=['Player','Runs Scored','BF','Ave','SR'])
            st.plotly_chart(fig, use_container_width=True)
